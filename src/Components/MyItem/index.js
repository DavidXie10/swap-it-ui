    ...
    return (
        <div className={`${backgroundcolor || ""}`}>
            ...
            <div className="grid lg:grid-rows-6 md:grid-rows-6 sm:grid-rows-8 grid-cols-5 lg:gap-1 md:gap-1 sm:gap-0 mt-8 mb-8">
                ...
                <Button width='lg:w-[180px] md:w-[140px] sm:w-[100px] lg:col-start-3 md:col-start-3 sm:col-start-2 flex justify-center items-center' height={'lg:h-[45px] md:h-[50px] sm:h-[55px] mt-4'} label='Editar' onClick={onClickEdit || ''} textcolor='text-white'/>
                <Button width='lg:w-[180px] md:w-[140px] sm:w-[100px] lg:col-start-4 md:col-start-4 sm:col-start-4 flex justify-center items-center ml-1 mt-4' height={'lg:h-[45px] md:h-[50px] sm:h-[55px]'} label='Eliminar' onClick={onClickDelete || ''} backgroundcolor='bg-[#8C8D8D]' textcolor='text-white'/>
            </div>
            <div className={`flex justify-end ${backgroundcolor || ""}`}></div>
        </div>
    )
