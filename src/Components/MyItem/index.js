    ...
    return (
        <div className={backgroundcolor}>
            <div className="grid grid-rows-6 grid-flow-col gap-2 ">
                ...
                <Label text={title || "Title not found"} width={'col-span-2'} height={'row-span-2'} backgroundcolor={backgroundcolor} ></Label>
                <Label text={`Estado: ${state || "State not found"}`} width={'col-span-2'} font={''} backgroundcolor={backgroundcolor}></Label>
                <Label text={`Ubicación: ${address || "Address not found"}`} width={'col-span-2'} font={''} backgroundcolor={backgroundcolor}></Label>
                <Label text={`Fecha de adquisición: ${acquisition || "Acquisition not found"}`} width={'col-span-2'} font={''} backgroundcolor={backgroundcolor}></Label>
                <Label text={`Busco: ${searchFor || "SearchFor not found"}`} width={'col-span-2'} font={''} backgroundcolor={backgroundcolor}></Label>
            </div>
